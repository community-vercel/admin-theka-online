    ...
    <div className="min-h-screen bg-gray-50">
      ...
      {isMobile && !isSidebarOpen && (
        <button
          ...
          className="fixed top-4 left-4 z-50 p-3 rounded-full bg-blue-600 text-white shadow-lg hover:bg-blue-700 transition-all lg:hidden"
      ...
      {/* Sidebar - Full menu on mobile */}
      <div className={`
        fixed left-0 top-0 h-screen z-40 transition-all duration-300 ease-in-out
        ${isMobile
          ? isSidebarOpen
            ? 'translate-x-0 w-72' // Wider on mobile for better touch
      ...
      `}>
        <Sidebar 
          ...
          isMobile={isMobile}
          isCollapsed={false} // Always expanded on mobile when open
